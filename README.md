...
* What is the runtime complexity to access an array, add or remove from the front, and add or remove from the back? A: O(1)
* What is the worse case scenario if you try to extend the storage size of a dynamic array? A: O(n)
